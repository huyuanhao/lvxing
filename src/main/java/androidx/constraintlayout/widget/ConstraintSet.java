...
import androidx.constraintlayout.widget.C0153R.C0154id;
...
public class ConstraintSet {
    ...
    /* renamed from: androidx.constraintlayout.widget.ConstraintSet$Constraint */
    ...
    static {
        mapToConstant.append(C0153R.styleable.ConstraintSet_layout_constraintLeft_toLeftOf, 25);
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i2 < split.length) {
            ...
            try {
                i = C0154id.class.getField(trim).getInt(null);
