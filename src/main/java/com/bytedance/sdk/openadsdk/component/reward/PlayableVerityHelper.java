...
public class PlayableVerityHelper {
    ...
    public static void m8718a(String str, int i, String str2, String str3, String str4) {
        ...
        try {
            ...
            jSONObject.put("external_url", str5);
            jSONObject.put(ArgKey.KEY_NAME, URLEncoder.encode("消灭病毒"));
            StringBuilder sb = new StringBuilder();
            sb.append(str);
            sb.append("?toutiao_card_params=");
            sb.append(URLEncoder.encode(jSONObject.toString()));
            String sb2 = sb.toString();
            if (a != null) {
                if (a.mo15512z() != null) {
                    a.mo15512z().mo15598d(sb2);
                }
                if (a.mo15426N() != null) {
                    if (!TextUtils.isEmpty(str2)) {
                        a.mo15426N().mo15344b(str2);
                        a.mo15426N().mo15347c("测试下载的app");
                    } else {
                        a.mo15426N().mo15344b((String) null);
                        a.mo15426N().mo15347c(str5);
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        a.mo15426N().mo15349d(str3);
                    }
                    if (!TextUtils.isEmpty(str4)) {
                        if (a.mo15427O() != null) {
                            a.mo15427O().mo15378a(str4);
                        } else {
                ...
                if (a.mo15415C() != null) {
                    a.mo15415C().mo15408a("http://sf1-ttcdn-tos.pstatp.com/obj/ttfe/adfe/union_endcard/Lark20190725-175511.png");
                }
                if (i == 1) {
                    a.mo15493j(15);
                } else {
            ...
            TTFullScreenVideoAdImpl iVar = new TTFullScreenVideoAdImpl(InternalContainer.m10059a(), a, new Builder().setOrientation(i).build());
            iVar.mo15158a(true);
