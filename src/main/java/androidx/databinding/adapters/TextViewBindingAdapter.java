...
public class TextViewBindingAdapter {
    ...
    /* renamed from: androidx.databinding.adapters.TextViewBindingAdapter$AfterTextChanged */
    public interface AfterTextChanged {
        void afterTextChanged(Editable editable);
    }

    /* renamed from: androidx.databinding.adapters.TextViewBindingAdapter$BeforeTextChanged */
    public interface BeforeTextChanged {
        void beforeTextChanged(CharSequence charSequence, int i, int i2, int i3);
    }

    /* renamed from: androidx.databinding.adapters.TextViewBindingAdapter$OnTextChanged */
        ...
        if (filters == null) {
            ...
            while (true) {
                ...
                if (inputFilter instanceof LengthFilter) {
                    boolean z2 = VERSION.SDK_INT < 21 || ((LengthFilter) inputFilter).getMax() != i;
                    if (z2) {
    ...
    public static void setTextWatcher(TextView textView, final BeforeTextChanged beforeTextChanged, final OnTextChanged onTextChanged, final AfterTextChanged afterTextChanged, final InverseBindingListener inverseBindingListener) {
        ...
        TextWatcher textWatcher2 = (TextWatcher) ListenerUtil.trackListener(textView, textWatcher, C0269R.C0270id.textWatcher);
