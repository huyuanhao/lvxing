...
final class StandardMenuPopup extends MenuPopup implements OnKeyListener, OnItemClickListener, OnDismissListener, MenuPresenter {
    private static final int ITEM_LAYOUT = C0039R.C0043layout.abc_popup_menu_item_layout;
        ...
        if (!this.mWasDismissed) {
            ...
            if (view != null) {
                ...
                if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
                    FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C0039R.C0043layout.abc_popup_menu_header_item_layout, listView, false);
