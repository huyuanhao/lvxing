...
public class JSONArray extends JSON implements Serializable, Cloneable, List<Object>, RandomAccess {
    ...
    public <T> T getObject(int i, Class<T> cls) {
        return TypeUtils.m3221a(this.list.get(i), cls);
    }

    public <T> T getObject(int i, Type type) {
        Object obj = this.list.get(i);
        if (type instanceof Class) {
            return TypeUtils.m3221a(obj, (Class) type);
        }
    ...
    public boolean getBooleanValue(int i) {
        ...
        return TypeUtils.m3276o(obj).booleanValue();
    }

    public Byte getByte(int i) {
        return TypeUtils.m3243b(get(i));
    }
    ...
    public byte getByteValue(int i) {
        ...
        return TypeUtils.m3243b(obj).byteValue();
    }

    public Short getShort(int i) {
        return TypeUtils.m3256d(get(i));
    }
    ...
    public short getShortValue(int i) {
        ...
        return TypeUtils.m3256d(obj).shortValue();
    }

    public Integer getInteger(int i) {
        return TypeUtils.m3274m(get(i));
    }
    ...
    public int getIntValue(int i) {
        ...
        return TypeUtils.m3274m(obj).intValue();
    }

    public Long getLong(int i) {
        return TypeUtils.m3273l(get(i));
    }
    ...
    public long getLongValue(int i) {
        ...
        return TypeUtils.m3273l(obj).longValue();
    }

    public Float getFloat(int i) {
        return TypeUtils.m3266g(get(i));
    }
    ...
    public float getFloatValue(int i) {
        ...
        return TypeUtils.m3266g(obj).floatValue();
    }

    public Double getDouble(int i) {
        return TypeUtils.m3269h(get(i));
    }
    ...
    public double getDoubleValue(int i) {
        ...
        return TypeUtils.m3269h(obj).doubleValue();
    }

    public BigDecimal getBigDecimal(int i) {
        return TypeUtils.m3260e(get(i));
    }

    public BigInteger getBigInteger(int i) {
        return TypeUtils.m3264f(get(i));
    }

    public String getString(int i) {
        return TypeUtils.m3226a(get(i));
    }

    public Date getDate(int i) {
        return TypeUtils.m3270i(get(i));
    }

    public java.sql.Date getSqlDate(int i) {
        return TypeUtils.m3271j(get(i));
    }

    public Timestamp getTimestamp(int i) {
        return TypeUtils.m3272k(get(i));
    }

    public <T> List<T> toJavaList(Class<T> cls) {
        ArrayList arrayList = new ArrayList(size());
        ParserConfig a = ParserConfig.m2904a();
        Iterator it = iterator();
        while (it.hasNext()) {
            arrayList.add(TypeUtils.m3222a(it.next(), cls, a));
        }
        return arrayList;
    }
