...
public class AsyncListDiffer<T> {
    ...
    /* renamed from: androidx.recyclerview.widget.AsyncListDiffer$ListListener */
    public interface ListListener<T> {
        void onCurrentListChanged(List<T> list, List<T> list2);
    }

    /* renamed from: androidx.recyclerview.widget.AsyncListDiffer$MainThreadExecutor */
