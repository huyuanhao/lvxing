...
public class ExpressClickListener extends ClickListener {
    /* renamed from: a */
    private DynamicClickInfo f7830a;

    public ExpressClickListener(Context context, MaterialMeta kVar, String str, int i) {
    ...
    public ClickEventModel mo15276a(int i, int i2, int i3, int i4, long j, long j2, View view, View view2) {
        ...
        int[] iArr = new int[2];
        int[] iArr2 = new int[2];
        DynamicClickInfo iVar = this.f7830a;
        if (iVar != null) {
            j3 = iVar.f7382e;
            j4 = this.f7830a.f7383f;
            iArr[0] = ((int) UIUtils.m12048a(this.f7197c, (float) this.f7830a.f7384g)) + i10;
            iArr[1] = ((int) UIUtils.m12048a(this.f7197c, (float) this.f7830a.f7385h)) + i9;
            int a2 = (int) UIUtils.m12048a(this.f7197c, (float) this.f7830a.f7387j);
            iArr2[0] = (int) UIUtils.m12048a(this.f7197c, (float) this.f7830a.f7386i);
            i11 = 1;
            iArr2[1] = a2;
        } else {
            i11 = 1;
    ...
    /* renamed from: a */
    public void mo15902a(DynamicClickInfo iVar) {
        this.f7830a = iVar;
    }
}
