...
class Styleable {
    ...
    /* renamed from: androidx.transition.Styleable$ArcMotion */
    interface ArcMotion {
    ...
    /* renamed from: androidx.transition.Styleable$ChangeBounds */
    interface ChangeBounds {
        public static final int RESIZE_CLIP = 0;
    }

    /* renamed from: androidx.transition.Styleable$ChangeTransform */
    interface ChangeTransform {
        public static final int REPARENT = 0;
        public static final int REPARENT_WITH_OVERLAY = 1;
    }

    /* renamed from: androidx.transition.Styleable$Fade */
    interface Fade {
        public static final int FADING_MODE = 0;
    }

    /* renamed from: androidx.transition.Styleable$PatternPathMotion */
    interface PatternPathMotion {
        public static final int PATTERN_PATH_DATA = 0;
    }

    /* renamed from: androidx.transition.Styleable$Slide */
    interface Slide {
        public static final int SLIDE_EDGE = 0;
    }

    /* renamed from: androidx.transition.Styleable$Transition */
    ...
    /* renamed from: androidx.transition.Styleable$TransitionManager */
    ...
    /* renamed from: androidx.transition.Styleable$TransitionSet */
    interface TransitionSet {
        public static final int TRANSITION_ORDERING = 0;
    }

    /* renamed from: androidx.transition.Styleable$TransitionTarget */
    ...
    /* renamed from: androidx.transition.Styleable$VisibilityTransition */
