...
public class BottomAppBar extends Toolbar implements AttachedBehavior {
    ...
    /* renamed from: com.google.android.material.bottomappbar.BottomAppBar$FabAlignmentMode */
    ...
    public BottomAppBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2622R.attr.bottomAppBarStyle);
    }
    ...
    public BottomAppBar(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2622R.styleable.BottomAppBar, i, C2622R.style.Widget_MaterialComponents_BottomAppBar, new int[0]);
        ColorStateList colorStateList = MaterialResources.getColorStateList(context, obtainStyledAttributes, C2622R.styleable.BottomAppBar_backgroundTint);
        float dimensionPixelOffset = (float) obtainStyledAttributes.getDimensionPixelOffset(C2622R.styleable.BottomAppBar_fabCradleMargin, 0);
        float dimensionPixelOffset2 = (float) obtainStyledAttributes.getDimensionPixelOffset(C2622R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0);
        float dimensionPixelOffset3 = (float) obtainStyledAttributes.getDimensionPixelOffset(C2622R.styleable.BottomAppBar_fabCradleVerticalOffset, 0);
        this.fabAlignmentMode = obtainStyledAttributes.getInt(C2622R.styleable.BottomAppBar_fabAlignmentMode, 0);
        this.hideOnScroll = obtainStyledAttributes.getBoolean(C2622R.styleable.BottomAppBar_hideOnScroll, false);
        obtainStyledAttributes.recycle();
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(C2622R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
    ...
    public void translateActionMenuView(ActionMenuView actionMenuView, int i, boolean z) {
        ...
        for (int i3 = 0; i3 < getChildCount(); i3++) {
            ...
            boolean z3 = (childAt.getLayoutParams() instanceof Toolbar.LayoutParams) && (((Toolbar.LayoutParams) childAt.getLayoutParams()).gravity & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK) == 8388611;
            if (z3) {
                i2 = Math.max(i2, z2 ? childAt.getLeft() : childAt.getRight());
            }
        }
        float right = (i != 1 || !z) ? 0.0f : (float) (i2 - (z2 ? actionMenuView.getRight() : actionMenuView.getLeft()));
    ...
    public void setCutoutState() {
        ...
        float f = (!this.fabAttached || !isVisibleFab()) ? 0.0f : 1.0f;
