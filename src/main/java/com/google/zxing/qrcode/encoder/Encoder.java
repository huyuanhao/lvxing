...
public final class Encoder {
    ...
    static /* synthetic */ class C28151 {
        ...
        L_0x0035:
            return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.qrcode.encoder.Encoder.C28151.m45407clinit():void");
        }
    }
    ...
    static void appendBytes(String str, Mode mode, BitArray bitArray, String str2) throws WriterException {
        int i = C28151.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {
