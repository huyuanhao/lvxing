...
public final class DefaultImageHeaderParser implements ImageHeaderParser {
    ...
    /* renamed from: com.bumptech.glide.load.resource.bitmap.DefaultImageHeaderParser$ByteBufferReader */
    ...
    /* renamed from: com.bumptech.glide.load.resource.bitmap.DefaultImageHeaderParser$RandomAccessReader */
    ...
    /* renamed from: com.bumptech.glide.load.resource.bitmap.DefaultImageHeaderParser$Reader */
    ...
    /* renamed from: com.bumptech.glide.load.resource.bitmap.DefaultImageHeaderParser$StreamReader */
    private static final class StreamReader implements Reader {
        /* renamed from: is */
        private final InputStream f4852is;

        StreamReader(InputStream inputStream) {
            this.f4852is = inputStream;
        }

        public int getUInt16() throws IOException {
            return ((this.f4852is.read() << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK) | (this.f4852is.read() & 255);
        }

        public short getUInt8() throws IOException {
            return (short) (this.f4852is.read() & 255);
        }
        ...
        public long skip(long j) throws IOException {
            ...
            long j2 = j;
            while (j2 > 0) {
                long skip = this.f4852is.skip(j2);
                if (skip <= 0) {
                    if (this.f4852is.read() == -1) {
                        break;
                    }
                    skip = 1;
                }
        ...
        public int read(byte[] bArr, int i) throws IOException {
            int i2 = i;
            while (i2 > 0) {
                int read = this.f4852is.read(bArr, i - i2, i2);
                if (read == -1) {
                    break;
                }
                i2 -= read;
    ...
    public ImageType getType(InputStream inputStream) throws IOException {
        return getType((Reader) new StreamReader((InputStream) Preconditions.m6138a(inputStream)));
    }

    public ImageType getType(ByteBuffer byteBuffer) throws IOException {
        return getType((Reader) new ByteBufferReader((ByteBuffer) Preconditions.m6138a(byteBuffer)));
    }

    public int getOrientation(InputStream inputStream, ArrayPool bVar) throws IOException {
        return getOrientation((Reader) new StreamReader((InputStream) Preconditions.m6138a(inputStream)), (ArrayPool) Preconditions.m6138a(bVar));
    }

    public int getOrientation(ByteBuffer byteBuffer, ArrayPool bVar) throws IOException {
        return getOrientation((Reader) new ByteBufferReader((ByteBuffer) Preconditions.m6138a(byteBuffer)), (ArrayPool) Preconditions.m6138a(bVar));
    }
    ...
    private int getOrientation(Reader reader, ArrayPool bVar) throws IOException {
        int uInt16 = reader.getUInt16();
        ...
        byte[] bArr = (byte[]) bVar.mo12702a(moveToExifSegmentAndGetLength, byte[].class);
        try {
