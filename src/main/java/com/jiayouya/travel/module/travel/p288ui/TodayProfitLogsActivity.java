...
import com.jiayouya.travel.module.travel.p290vm.TodayProfitLogsVM;
...
/* compiled from: TodayProfitLogsActivity.kt */
/* renamed from: com.jiayouya.travel.module.travel.ui.TodayProfitLogsActivity */
public final class TodayProfitLogsActivity extends BaseActivity<ActivityTodayProfitLogsBinding, TodayProfitLogsVM> {
    /* renamed from: c */
    private final BindingType f11935c = BindingType.create(TodayPorfitLogsItem.class, (int) R.layout.item_today_profit_logs);
    /* access modifiers changed from: private|final */
    /* renamed from: d */
    public final EndlessAdapter f11936d = new EndlessAdapter(this.f11935c, ItemTypes.f9670a.mo20024a());
    /* renamed from: e */
    private HashMap f11937e;
    ...
    /* compiled from: TodayProfitLogsActivity.kt */
    /* renamed from: com.jiayouya.travel.module.travel.ui.TodayProfitLogsActivity$a */
    static final class C3338a<T> implements Observer<DataPage<TodayPorfitLogsItem>> {
        /* renamed from: a */
        final /* synthetic */ TodayProfitLogsActivity f11938a;

        C3338a(TodayProfitLogsActivity todayProfitLogsActivity) {
            this.f11938a = todayProfitLogsActivity;
        }

        /* renamed from: a */
        public final void onChanged(DataPage<TodayPorfitLogsItem> dataPage) {
            AdapterEx.m12806a(this.f11938a.f11936d, dataPage, null, false, 6, null);
        }
    }

    @Metadata(mo39187bv = {1, 0, 3}, mo39188d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, mo39189d2 = {"<anonymous>", "", "it", "Lcom/scwang/smartrefresh/layout/api/RefreshLayout;", "onRefresh"}, mo39190k = 3, mo39191mv = {1, 1, 15})
    /* compiled from: TodayProfitLogsActivity.kt */
    /* renamed from: com.jiayouya.travel.module.travel.ui.TodayProfitLogsActivity$b */
    static final class C3339b implements OnRefreshListener {
        /* renamed from: a */
        final /* synthetic */ TodayProfitLogsActivity f11939a;

        C3339b(TodayProfitLogsActivity todayProfitLogsActivity) {
            this.f11939a = todayProfitLogsActivity;
        }

        /* renamed from: a_ */
        public final void mo20372a_(RefreshLayout jVar) {
            C8271i.m35386b(jVar, "it");
            BaseActivity.m12847a(this.f11939a, false, 1, null);
        }
    }

    @Metadata(mo39187bv = {1, 0, 3}, mo39188d1 = {"\u0000\b\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"}, mo39189d2 = {"<anonymous>", "", "onLoadMore"}, mo39190k = 3, mo39191mv = {1, 1, 15})
    /* compiled from: TodayProfitLogsActivity.kt */
    /* renamed from: com.jiayouya.travel.module.travel.ui.TodayProfitLogsActivity$c */
    static final class C3340c implements OnLoadMoreListener {
        /* renamed from: a */
        final /* synthetic */ TodayProfitLogsActivity f11940a;

        C3340c(TodayProfitLogsActivity todayProfitLogsActivity) {
            this.f11940a = todayProfitLogsActivity;
        }

        public final void onLoadMore() {
            this.f11940a.mo19858b(false);
        }
    }
    ...
    public View mo19852a(int i) {
        ...
        View view = (View) this.f11937e.get(Integer.valueOf(i));
        if (view != null) {
            return view;
        }
        View findViewById = findViewById(i);
        this.f11937e.put(Integer.valueOf(i), findViewById);
        return findViewById;
    }
    ...
    /* renamed from: d */
    public Class<TodayProfitLogsVM> mo19861d() {
        return TodayProfitLogsVM.class;
    }

    /* renamed from: a */
    public void mo19854a(Bundle bundle) {
        ((SmartRefreshLayout) mo19852a(R.id.refresh)).mo30862a((OnRefreshListener) new C3339b(this));
        this.f11936d.setOnLoadMoreListener(new C3340c(this));
        ...
        recyclerView.setAdapter(this.f11936d);
    ...
    public boolean mo19865h() {
        return AdapterEx.m12807a(this.f11936d);
    }
    ...
    public void mo19858b(boolean z) {
        ((TodayProfitLogsVM) mo19853a()).mo22415a(z);
    }

    /* renamed from: g */
    public void mo19864g() {
        super.mo19864g();
        ((TodayProfitLogsVM) mo19853a()).mo22416b().observe(this, new C3338a(this));
    }
}
