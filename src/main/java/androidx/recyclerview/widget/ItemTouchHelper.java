...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    /* renamed from: androidx.recyclerview.widget.ItemTouchHelper$Callback */
    public static abstract class Callback {
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0418R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
    ...
    /* renamed from: androidx.recyclerview.widget.ItemTouchHelper$ItemTouchHelperGestureListener */
    ...
    /* renamed from: androidx.recyclerview.widget.ItemTouchHelper$RecoverAnimation */
    ...
    /* renamed from: androidx.recyclerview.widget.ItemTouchHelper$SimpleCallback */
    ...
    /* renamed from: androidx.recyclerview.widget.ItemTouchHelper$ViewDropHandler */
    ...
    public void attachToRecyclerView(RecyclerView recyclerView) {
        ...
        if (recyclerView2 != recyclerView) {
            ...
            if (recyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0418R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0418R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
    ...
    L_0x0098:
        ...
        r21 = 8
        r10 = r22
        r0.m40006init(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10)
