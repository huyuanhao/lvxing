...
public class GifDrawable extends Drawable implements Animatable, Animatable2Compat, FrameCallback {
    ...
    /* renamed from: com.bumptech.glide.load.resource.gif.GifDrawable$GifState */
    ...
    @Deprecated
    public GifDrawable(Context context, GifDecoder gifDecoder, BitmapPool eVar, Transformation<Bitmap> iVar, int i, int i2, Bitmap bitmap) {
        this(context, gifDecoder, iVar, i, i2, bitmap);
    }

    public GifDrawable(Context context, GifDecoder gifDecoder, Transformation<Bitmap> iVar, int i, int i2, Bitmap bitmap) {
        GifFrameLoader gifFrameLoader = new GifFrameLoader(Glide.m5169a(context), gifDecoder, i, i2, iVar, bitmap);
    ...
    GifDrawable(GifState gifState) {
        this.isVisible = true;
        this.maxLoopCount = -1;
        this.state = (GifState) Preconditions.m6138a(gifState);
    }
    ...
    public void setFrameTransformation(Transformation<Bitmap> iVar, Bitmap bitmap) {
        this.state.frameLoader.setFrameTransformation(iVar, bitmap);
    }
    ...
    public void startFromFirstFrame() {
        Preconditions.m6142a(!this.isRunning, "You cannot restart a currently running animation.");
    ...
    private void startRunning() {
        Preconditions.m6142a(!this.isRecycled, "You cannot start a recycled Drawable. Ensure thatyou clear any references to the Drawable when clearing the corresponding request.");
    ...
    public boolean setVisible(boolean z, boolean z2) {
        Preconditions.m6142a(!this.isRecycled, "Cannot change the visibility of a recycled resource. Ensure that you unset the Drawable from your View before changing the View's visibility.");
        this.isVisible = z;
        if (!z) {
            stopRunning();
