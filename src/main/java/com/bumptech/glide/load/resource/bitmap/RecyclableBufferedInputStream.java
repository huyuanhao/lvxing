...
public class RecyclableBufferedInputStream extends FilterInputStream {
    ...
    /* renamed from: com.bumptech.glide.load.resource.bitmap.RecyclableBufferedInputStream$InvalidMarkException */
    ...
    RecyclableBufferedInputStream(InputStream inputStream, ArrayPool bVar, int i) {
        ...
        this.buf = (byte[]) bVar.mo12702a(i, byte[].class);
    }
    ...
    public synchronized void release() {
        if (this.buf != null) {
            this.byteArrayPool.mo12705a(this.buf);
            this.buf = null;
        }
    }
        ...
        if (i != -1) {
            ...
            if (i2 < i3) {
                if (i == 0 && i3 > bArr.length && this.count == bArr.length) {
                    ...
                    byte[] bArr2 = (byte[]) this.byteArrayPool.mo12702a(length, byte[].class);
