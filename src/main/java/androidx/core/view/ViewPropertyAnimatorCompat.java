...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: androidx.core.view.ViewPropertyAnimatorCompat$ViewPropertyAnimatorListenerApi14 */
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo5008x(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo5010y(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo5012z(float f) {
        View view = (View) this.mView.get();
        if (view != null && VERSION.SDK_INT >= 21) {
            view.animate().z(f);
        }
