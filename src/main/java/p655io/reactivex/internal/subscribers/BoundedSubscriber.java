...
public final class BoundedSubscriber<T> extends AtomicReference<Subscription> implements Disposable, C8085e<T>, Subscription {
    ...
    public BoundedSubscriber(Consumer<? super T> gVar, Consumer<? super Throwable> gVar2, C8083a aVar, Consumer<? super Subscription> gVar3, int i) {
        this.onNext = gVar;
        this.onError = gVar2;
