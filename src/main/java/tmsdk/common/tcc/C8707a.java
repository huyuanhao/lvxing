...
/* renamed from: tmsdk.common.tcc.a */
class C8707a {
    /* renamed from: a */
    private static void m37727a(byte[] bArr, int[] iArr) {
    ...
    /* renamed from: a */
    private static void m37728a(int[] iArr, int i, byte[] bArr) {
        int i2;
        int length = bArr.length >> 2;
        if (length > i) {
            length = i;
    ...
    public static byte[] decrypt(byte[] bArr, byte[] bArr2) {
        ...
        if (bArr.length % 4 == 0 && bArr.length >= 8) {
            ...
            if (i10 >= 0 && i10 <= ((iArr.length - 1) << 2)) {
                ...
                m37728a(iArr, iArr.length - 1, bArr3);
                return bArr3;
            }
        }
        return null;
    ...
    public static byte[] encrypt(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i4 > 0) {
                ...
                int i13 = iArr[0];
                i5 = iArr[length3] + ((((i9 >>> 5) ^ (i13 << 2)) + ((i13 >>> 3) ^ (i9 << 4))) ^ ((i13 ^ i6) + (iArr2[i8 ^ (i10 & 3)] ^ i9)));
                iArr[length3] = i5;
                i4 = i7;
            } else {
                byte[] bArr3 = new byte[(iArr.length << 2)];
                m37728a(iArr, iArr.length, bArr3);
                return bArr3;
            }
        }
    }
    ...
    public static byte[] getKey() {
        try {
            return "DFG#$%^#%$RGHR(&*M<><".getBytes("UTF-8");
