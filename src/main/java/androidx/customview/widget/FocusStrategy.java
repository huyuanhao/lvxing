...
class FocusStrategy {
    ...
    /* renamed from: androidx.customview.widget.FocusStrategy$BoundsAdapter */
    public interface BoundsAdapter<T> {
        void obtainBounds(T t, Rect rect);
    }

    /* renamed from: androidx.customview.widget.FocusStrategy$CollectionAdapter */
    ...
    /* renamed from: androidx.customview.widget.FocusStrategy$SequentialComparator */
