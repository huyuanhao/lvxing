...
public final class PayloadReader {
    /* renamed from: a */
    public static String m19526a(File file, int i) {
        byte[] b = m19529b(file, i);
        if (b == null) {
            return null;
        }
        try {
    ...
    /* renamed from: b */
    public static byte[] m19529b(File file, int i) {
        Map a = m19527a(file);
        if (a == null) {
            return null;
        }
        ...
        return m19528a(byteBuffer);
    }

    /* renamed from: a */
    private static byte[] m19528a(ByteBuffer byteBuffer) {
    ...
    /* renamed from: a */
    private static java.util.Map<java.lang.Integer, java.nio.ByteBuffer> m19527a(java.io.File r3) {
        /*
        r0 = 0
        ...
        com.meituan.android.walle.d r2 = com.meituan.android.walle.ApkUtil.m19519c(r3)     // Catch:{ IOException -> 0x003c, all -> 0x0023 }
        java.lang.Object r2 = r2.mo25365a()     // Catch:{ IOException -> 0x003c, all -> 0x0023 }
        java.nio.ByteBuffer r2 = (java.nio.ByteBuffer) r2     // Catch:{ IOException -> 0x003c, all -> 0x0023 }
        java.util.Map r0 = com.meituan.android.walle.ApkUtil.m19515a(r2)     // Catch:{ IOException -> 0x003c, all -> 0x0023 }
    ...
    L_0x0046:
        return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meituan.android.walle.PayloadReader.m19527a(java.io.File):java.util.Map");
    }
}
