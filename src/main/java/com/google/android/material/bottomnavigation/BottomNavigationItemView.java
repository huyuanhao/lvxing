...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C2622R.C2626layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C2622R.C2623drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C2622R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C2622R.C2624id.icon);
        this.smallLabel = (TextView) findViewById(C2622R.C2624id.smallLabel);
        this.largeLabel = (TextView) findViewById(C2622R.C2624id.largeLabel);
