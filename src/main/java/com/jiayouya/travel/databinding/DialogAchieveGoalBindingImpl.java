...
public class DialogAchieveGoalBindingImpl extends DialogAchieveGoalBinding {
    /* renamed from: d */
    private static final IncludedLayouts f10258d = null;
    /* renamed from: e */
    private static final SparseIntArray f10259e = new SparseIntArray();
    /* renamed from: f */
    private final LinearLayout f10260f;
    /* renamed from: g */
    private final TextView f10261g;
    /* renamed from: h */
    private final LinearLayout f10262h;
    /* renamed from: i */
    private final TextView f10263i;
    /* renamed from: j */
    private final TextView f10264j;
    /* renamed from: k */
    ...
    static {
        f10259e.put(R.id.iv_close, 5);
        f10259e.put(R.id.btn, 6);
    }

    public DialogAchieveGoalBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 7, f10258d, f10259e));
    }

    private DialogAchieveGoalBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (RoundText) objArr[6], (ImageView) objArr[5]);
        this.f10265k = -1;
        this.f10260f = objArr[0];
        this.f10260f.setTag(null);
        this.f10261g = objArr[1];
        this.f10261g.setTag(null);
        this.f10262h = objArr[2];
        this.f10262h.setTag(null);
        this.f10263i = objArr[3];
        this.f10263i.setTag(null);
        this.f10264j = objArr[4];
        this.f10264j.setTag(null);
        setRootTag(view);
        invalidateAll();
    }
    ...
    public boolean setVariable(int i, Object obj) {
        ...
        mo20104a((TargetRewards) obj);
        return true;
    }

    /* renamed from: a */
    public void mo20104a(TargetRewards targetRewards) {
        this.f10257c = targetRewards;
        synchronized (this) {
            this.f10265k |= 1;
        }
    ...
    public void executeBindings() {
        ...
        TargetRewards targetRewards = this.f10257c;
        int i = ((3 & j) > 0 ? 1 : ((3 & j) == 0 ? 0 : -1));
        if (i != 0) {
            if (targetRewards != null) {
                charSequence2 = targetRewards.getAmount();
                str = targetRewards.getNextRate();
                charSequence3 = targetRewards.getNextTarget();
            } else {
                charSequence3 = null;
                charSequence2 = null;
                str = null;
        ...
        if ((j & 2) != 0) {
            LinearLayout linearLayout = this.f10260f;
