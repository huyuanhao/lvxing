...
public class FileProvider extends ContentProvider {
    ...
    /* renamed from: androidx.core.content.FileProvider$PathStrategy */
    ...
    /* renamed from: androidx.core.content.FileProvider$SimplePathStrategy */
            ...
            try {
                ...
                if (entry != null) {
                    ...
                    if (path2.endsWith(str2)) {
                        str = r6.substring(path2.length());
                    } else {
                        str = r6.substring(path2.length() + 1);
                    }
                    StringBuilder sb = new StringBuilder();
                    sb.append(Uri.encode((String) entry.getKey()));
                    sb.append('/');
                    sb.append(Uri.encode(str, str2));
                    return new Builder().scheme(MessageKey.MSG_CONTENT).authority(this.mAuthority).encodedPath(sb.toString()).build();
                }
