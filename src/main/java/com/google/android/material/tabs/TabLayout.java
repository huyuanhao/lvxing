...
public class TabLayout extends HorizontalScrollView {
    ...
    /* renamed from: com.google.android.material.tabs.TabLayout$AdapterChangeListener */
    ...
    /* renamed from: com.google.android.material.tabs.TabLayout$BaseOnTabSelectedListener */
    ...
    /* renamed from: com.google.android.material.tabs.TabLayout$Mode */
    public @interface Mode {
    }

    /* renamed from: com.google.android.material.tabs.TabLayout$OnTabSelectedListener */
    public interface OnTabSelectedListener extends BaseOnTabSelectedListener<Tab> {
    }

    /* renamed from: com.google.android.material.tabs.TabLayout$PagerAdapterObserver */
    ...
    /* renamed from: com.google.android.material.tabs.TabLayout$SlidingTabIndicator */
    private class SlidingTabIndicator extends LinearLayout {
        ...
        public void animateIndicatorToPosition(final int i, int i2) {
            ...
            if (!(i5 == i3 && i6 == i4)) {
                ...
                C26931 r3 = new AnimatorUpdateListener() {
    ...
    /* renamed from: com.google.android.material.tabs.TabLayout$Tab */
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* renamed from: com.google.android.material.tabs.TabLayout$TabGravity */
    public @interface TabGravity {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* renamed from: com.google.android.material.tabs.TabLayout$TabIndicatorGravity */
    public @interface TabIndicatorGravity {
    }

    /* renamed from: com.google.android.material.tabs.TabLayout$TabLayoutOnPageChangeListener */
    ...
    /* renamed from: com.google.android.material.tabs.TabLayout$TabView */
    class TabView extends LinearLayout {
        ...
        public TabView(Context context) {
            ...
            setGravity(17);
            setOrientation(!TabLayout.this.inlineLabel);
            setClickable(true);
        ...
        public final void update() {
            ...
            if (this.customView == null) {
                if (this.iconView == null) {
                    ImageView imageView2 = (ImageView) LayoutInflater.from(getContext()).inflate(C2622R.C2626layout.design_layout_tab_icon, this, false);
                ...
                if (this.textView == null) {
                    TextView textView4 = (TextView) LayoutInflater.from(getContext()).inflate(C2622R.C2626layout.design_layout_tab_text, this, false);
                    addView(textView4);
    ...
    /* renamed from: com.google.android.material.tabs.TabLayout$ViewPagerOnTabSelectedListener */
    ...
    public TabLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2622R.attr.tabStyle);
    }
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2622R.styleable.TabLayout, i, C2622R.style.Widget_Design_TabLayout, C2622R.styleable.TabLayout_tabTextAppearance);
        this.slidingTabIndicator.setSelectedIndicatorHeight(obtainStyledAttributes.getDimensionPixelSize(C2622R.styleable.TabLayout_tabIndicatorHeight, -1));
        this.slidingTabIndicator.setSelectedIndicatorColor(obtainStyledAttributes.getColor(C2622R.styleable.TabLayout_tabIndicatorColor, 0));
        setSelectedTabIndicator(MaterialResources.getDrawable(context, obtainStyledAttributes, C2622R.styleable.TabLayout_tabIndicator));
        setSelectedTabIndicatorGravity(obtainStyledAttributes.getInt(C2622R.styleable.TabLayout_tabIndicatorGravity, 0));
        setTabIndicatorFullWidth(obtainStyledAttributes.getBoolean(C2622R.styleable.TabLayout_tabIndicatorFullWidth, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C2622R.styleable.TabLayout_tabPadding, 0);
        this.tabPaddingBottom = dimensionPixelSize;
        this.tabPaddingEnd = dimensionPixelSize;
        this.tabPaddingTop = dimensionPixelSize;
        this.tabPaddingStart = dimensionPixelSize;
        this.tabPaddingStart = obtainStyledAttributes.getDimensionPixelSize(C2622R.styleable.TabLayout_tabPaddingStart, this.tabPaddingStart);
        this.tabPaddingTop = obtainStyledAttributes.getDimensionPixelSize(C2622R.styleable.TabLayout_tabPaddingTop, this.tabPaddingTop);
        this.tabPaddingEnd = obtainStyledAttributes.getDimensionPixelSize(C2622R.styleable.TabLayout_tabPaddingEnd, this.tabPaddingEnd);
        this.tabPaddingBottom = obtainStyledAttributes.getDimensionPixelSize(C2622R.styleable.TabLayout_tabPaddingBottom, this.tabPaddingBottom);
        this.tabTextAppearance = obtainStyledAttributes.getResourceId(C2622R.styleable.TabLayout_tabTextAppearance, C2622R.style.TextAppearance_Design_Tab);
        ...
        try {
            ...
            if (obtainStyledAttributes.hasValue(C2622R.styleable.TabLayout_tabTextColor)) {
                this.tabTextColors = MaterialResources.getColorStateList(context, obtainStyledAttributes, C2622R.styleable.TabLayout_tabTextColor);
            }
            if (obtainStyledAttributes.hasValue(C2622R.styleable.TabLayout_tabSelectedTextColor)) {
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), obtainStyledAttributes.getColor(C2622R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.tabIconTint = MaterialResources.getColorStateList(context, obtainStyledAttributes, C2622R.styleable.TabLayout_tabIconTint);
            this.tabIconTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C2622R.styleable.TabLayout_tabIconTintMode, -1), null);
            this.tabRippleColorStateList = MaterialResources.getColorStateList(context, obtainStyledAttributes, C2622R.styleable.TabLayout_tabRippleColor);
            this.tabIndicatorAnimationDuration = obtainStyledAttributes.getInt(C2622R.styleable.TabLayout_tabIndicatorAnimationDuration, 300);
            this.requestedTabMinWidth = obtainStyledAttributes.getDimensionPixelSize(C2622R.styleable.TabLayout_tabMinWidth, -1);
            this.requestedTabMaxWidth = obtainStyledAttributes.getDimensionPixelSize(C2622R.styleable.TabLayout_tabMaxWidth, -1);
            this.tabBackgroundResId = obtainStyledAttributes.getResourceId(C2622R.styleable.TabLayout_tabBackground, 0);
            this.contentInsetStart = obtainStyledAttributes.getDimensionPixelSize(C2622R.styleable.TabLayout_tabContentStart, 0);
            this.mode = obtainStyledAttributes.getInt(C2622R.styleable.TabLayout_tabMode, 1);
            this.tabGravity = obtainStyledAttributes.getInt(C2622R.styleable.TabLayout_tabGravity, 0);
            this.inlineLabel = obtainStyledAttributes.getBoolean(C2622R.styleable.TabLayout_tabInlineLabel, false);
            this.unboundedRipple = obtainStyledAttributes.getBoolean(C2622R.styleable.TabLayout_tabUnboundedRipple, false);
            obtainStyledAttributes.recycle();
            Resources resources = getResources();
            this.tabTextMultiLineSize = (float) resources.getDimensionPixelSize(C2622R.dimen.design_tab_text_size_2line);
            this.scrollableTabMinWidth = resources.getDimensionPixelSize(C2622R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } catch (Throwable th) {
            obtainStyledAttributes2.recycle();
            throw th;
