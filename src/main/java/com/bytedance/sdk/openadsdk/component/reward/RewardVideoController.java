...
public class RewardVideoController extends BaseVideoController {
    ...
    public RewardVideoController(Context context, ViewGroup viewGroup, MaterialMeta kVar) {
    ...
    public void mo15107a(int i, int i2) {
        if (this.f7947b != null) {
            ...
            AdEventManager.m8412k((Context) this.f7946a.get(), this.f7947b, "rewarded_video", str, a);
        }
    }
    ...
    public void mo15108b() {
        ...
        AdEventManager.m8386a((Context) this.f7946a.get(), this.f7947b, "rewarded_video", "feed_over", this.f7948c, 100, B);
    }
    ...
    public void mo15109c() {
        Map B = mo15948B();
        B.put("play_type", Integer.valueOf(ToolUtils.m11990a((INativeVideoController) this, this.f7952g)));
        AdEventManager.m8386a((Context) this.f7946a.get(), this.f7947b, "rewarded_video", "play_pause", mo15991o(), mo15993q(), B);
    }
    ...
    public void mo15110d() {
        Map B = mo15948B();
        B.put("play_type", Integer.valueOf(ToolUtils.m11990a((INativeVideoController) this, this.f7952g)));
        AdEventManager.m8386a((Context) this.f7946a.get(), this.f7947b, "rewarded_video", "continue_play", this.f7953h, mo15993q(), B);
    }
    ...
    public void mo15111e() {
        Map A = mo15947A();
        A.put("play_type", Integer.valueOf(ToolUtils.m11990a((INativeVideoController) this, this.f7952g)));
        AdEventManager.m8411j((Context) this.f7946a.get(), this.f7947b, "rewarded_video", "feed_play", A);
    }
