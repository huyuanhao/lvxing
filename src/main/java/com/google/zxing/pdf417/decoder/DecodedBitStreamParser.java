...
final class DecodedBitStreamParser {
    /* renamed from: AL */
    private static final int f9514AL = 28;
    /* renamed from: AS */
    private static final int f9515AS = 27;
    ...
    /* renamed from: LL */
    private static final int f9516LL = 27;
    ...
    /* renamed from: ML */
    private static final int f9517ML = 28;
    private static final int MODE_SHIFT_TO_BYTE_COMPACTION_MODE = 913;
    private static final int NUMBER_OF_SEQUENCE_CODEWORDS = 2;
    private static final int NUMERIC_COMPACTION_MODE_LATCH = 902;
    private static final int PAL = 29;
    /* renamed from: PL */
    private static final int f9518PL = 25;
    /* renamed from: PS */
    private static final int f9519PS = 29;
    private static final char[] PUNCT_CHARS = ";<>@[\\]_`~!\r\t,:\n-.$/\"|*()?{}'".toCharArray();
    private static final int TEXT_COMPACTION_MODE_LATCH = 900;

    /* renamed from: com.google.zxing.pdf417.decoder.DecodedBitStreamParser$Mode */
    private enum Mode {
        ALPHA,
        LOWER,
        MIXED,
    ...
    L_0x0008:
        ...
        r4 = r12[r0]
        int[] r5 = com.google.zxing.pdf417.decoder.DecodedBitStreamParser.C28031.f9520x45bba1d
        int r6 = r1.ordinal()
        r5 = r5[r6]
        r6 = 32
        r7 = 29
