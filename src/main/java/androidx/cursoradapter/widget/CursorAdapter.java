...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilterClient {
    ...
    /* renamed from: androidx.cursoradapter.widget.CursorAdapter$ChangeObserver */
    ...
    /* renamed from: androidx.cursoradapter.widget.CursorAdapter$MyDataSetObserver */
    ...
    public void init(Context context, Cursor cursor, int i) {
        ...
        this.mRowIDColumn = z ? cursor.getColumnIndexOrThrow(C7887a.f26833ID) : -1;
        if ((i & 2) == 2) {
    ...
    public Cursor swapCursor(Cursor cursor) {
        ...
        if (cursor != null) {
            ...
            this.mRowIDColumn = cursor.getColumnIndexOrThrow(C7887a.f26833ID);
