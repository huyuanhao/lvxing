...
public final class GeneralRoundRelativeLayout extends RelativeLayout {
    ...
    public GeneralRoundRelativeLayout(Context context, AttributeSet attributeSet) {
        ...
        m13652a(this, context, attributeSet);
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        GeneralRoundViewImpl aVar = this.f11387a;
        if (aVar == null) {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        GeneralRoundViewImpl aVar2 = this.f11387a;
        if (aVar2 == null) {
            C8271i.m35387b(str);
        }
    ...
    /* renamed from: a */
    private final void m13652a(View view, Context context, AttributeSet attributeSet) {
        int[] iArr = R.styleable.GeneralRoundRelativeLayout;
        C8271i.m35382a((Object) iArr, "R.styleable.GeneralRoundRelativeLayout");
