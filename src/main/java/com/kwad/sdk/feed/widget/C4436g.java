...
/* renamed from: com.kwad.sdk.feed.widget.g */
public class C4436g extends C4419a implements OnClickListener {
    /* renamed from: f */
    private TextView f14534f;
    /* renamed from: g */
    private ImageView f14535g;
    /* renamed from: h */
    private ImageView f14536h;

    public C4436g(Context context) {
        super(context);
    }
    ...
    public void mo24712a() {
        this.f14534f = (TextView) findViewById(C3809l.m15789a(this.f14495d, "ksad_ad_desc"));
        ((RatioFrameLayout) findViewById(C3809l.m15789a(this.f14495d, "ksad_image_container"))).setRatio(0.66f);
        this.f14535g = (ImageView) findViewById(C3809l.m15789a(this.f14495d, "ksad_ad_image"));
        this.f14536h = (ImageView) findViewById(C3809l.m15789a(this.f14495d, "ksad_ad_dislike"));
    }

    /* renamed from: a */
    public void mo24713a(AdTemplate adTemplate) {
        super.mo24713a(adTemplate);
        this.f14534f.setText(C4322a.m17643k(this.f14493b));
        List x = C4322a.m17656x(this.f14493b);
        if (x.size() >= 1) {
            KSImageLoader.loadFeeImage(this.f14535g, (String) x.get(0));
        } else {
            C4065b.m16869d("FeedTextLeftImageView", "getImageUrlList size less than one");
        }
    ...
    public int getLayoutId() {
        return C3809l.m15792b(this.f14495d, "ksad_feed_text_left_image");
    }

    public void onClick(View view) {
        if (view == this.f14536h) {
            mo24721d();
