...
public final class ScheduledRunnable extends AtomicReferenceArray<Object> implements Disposable, Runnable, Callable<Object> {
    ...
    public ScheduledRunnable(Runnable runnable, DisposableContainer aVar) {
        super(3);
    ...
    public void run() {
        ...
        try {
            ...
            if (!(obj2 == PARENT_DISPOSED || !compareAndSet(0, obj2, DONE) || obj2 == null)) {
                ((DisposableContainer) obj2).mo38832c(this);
            }
            while (true) {
                Object obj3 = get(1);
        ...
        if (!(obj4 == PARENT_DISPOSED || !compareAndSet(0, obj4, DONE) || obj4 == null)) {
            ((DisposableContainer) obj4).mo38832c(this);
        }
        do {
            obj = get(1);
    ...
    L_0x0044:
        ...
        if (r1 == 0) goto L_0x0035
        io.reactivex.internal.disposables.a r0 = (p655io.reactivex.internal.disposables.DisposableContainer) r0
        r0.mo38832c(r5)
    L_0x004f:
        return
        */
        throw new UnsupportedOperationException("Method not decompiled: p655io.reactivex.internal.schedulers.ScheduledRunnable.dispose():void");
    }
