...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String str, int i, int i2, List<TypeAdapterFactory> list) {
        ...
        if (str != null) {
            if (!"".equals(str.trim())) {
                DefaultDateTypeAdapter defaultDateTypeAdapter = new DefaultDateTypeAdapter(Date.class, str);
                typeAdapter = new DefaultDateTypeAdapter(Timestamp.class, str);
                typeAdapter3 = new DefaultDateTypeAdapter(java.sql.Date.class, str);
                typeAdapter2 = defaultDateTypeAdapter;
                list.add(TypeAdapters.newFactory(Date.class, typeAdapter2));
                list.add(TypeAdapters.newFactory(Timestamp.class, typeAdapter));
                list.add(TypeAdapters.newFactory(java.sql.Date.class, typeAdapter3));
            }
        }
        if (i != 2 && i2 != 2) {
            typeAdapter2 = new DefaultDateTypeAdapter(Date.class, i, i2);
