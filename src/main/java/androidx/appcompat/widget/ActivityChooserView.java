...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    /* renamed from: androidx.appcompat.widget.ActivityChooserView$ActivityChooserViewAdapter */
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType == 0) {
                if (view == null || view.getId() != C0039R.C0041id.list_item) {
                    view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0039R.C0043layout.abc_activity_chooser_view_list_item, viewGroup, false);
                }
    ...
    /* renamed from: androidx.appcompat.widget.ActivityChooserView$Callbacks */
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0039R.C0043layout.abc_activity_chooser_view, this, true);
