...
public class LinearLayoutCompat extends ViewGroup {
    ...
    /* renamed from: androidx.appcompat.widget.LinearLayoutCompat$DividerMode */
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* renamed from: androidx.appcompat.widget.LinearLayoutCompat$OrientationMode */
    ...
    public void layoutVertical(int i, int i2, int i3, int i4) {
        ...
        while (i13 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                nextLocationOffset = i5 + measureNullChild(i13);
                ...
                nextLocationOffset = i16 + measuredHeight + layoutParams2.bottomMargin + getNextLocationOffset(virtualChildAt);
            }
            i13++;
        }
    }
