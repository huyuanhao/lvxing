...
public class IconCompat extends CustomVersionedParcelable {
    ...
    /* renamed from: androidx.core.graphics.drawable.IconCompat$IconType */
    ...
    /* JADX WARNING: type inference failed for: r0v12, types: [java.io.InputStream] */
    /* JADX WARNING: type inference failed for: r0v14 */
    /* JADX WARNING: type inference failed for: r0v17, types: [java.io.InputStream] */
    /* JADX WARNING: type inference failed for: r1v16, types: [java.io.FileInputStream] */
    ...
    private static int getType(Icon icon) {
        ...
        try {
            r7 = icon;
            r7 = ((Integer) icon.getClass().getMethod("getType", new Class[0]).invoke(icon, new Object[0])).intValue();
            r7 = r7;
            return r7;
