...
class TranslationAnimationCreator {
    ...
    /* renamed from: androidx.transition.TranslationAnimationCreator$TransitionPositionListener */
    private static class TransitionPositionListener extends AnimatorListenerAdapter {
        ...
        private int[] mTransitionPosition = ((int[]) this.mViewInHierarchy.getTag(C0516R.C0518id.transition_position));
        ...
        TransitionPositionListener(View view, View view2, int i, int i2, float f, float f2) {
            ...
            if (this.mTransitionPosition != null) {
                this.mViewInHierarchy.setTag(C0516R.C0518id.transition_position, null);
            }
        }
        ...
        public void onAnimationCancel(Animator animator) {
            ...
            this.mViewInHierarchy.setTag(C0516R.C0518id.transition_position, this.mTransitionPosition);
        }
    ...
    static Animator createAnimation(View view, TransitionValues transitionValues, int i, int i2, float f, float f2, float f3, float f4, TimeInterpolator timeInterpolator) {
        ...
        int[] iArr = (int[]) transitionValues2.view.getTag(C0516R.C0518id.transition_position);
        if (iArr != null) {
