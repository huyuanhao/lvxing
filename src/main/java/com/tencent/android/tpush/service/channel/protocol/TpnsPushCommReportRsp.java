...
public final class TpnsPushCommReportRsp extends JceStruct implements Cloneable {
    static final /* synthetic */ boolean $assertionsDisabled = false;
    public byte padding = 0;

    public String className() {
        return "TPNS_CLIENT_PROTOCOL.TpnsPushCommReportRsp";
    }

    public String fullClassName() {
        return "com.tencent.android.tpush.service.channel.protocol.TpnsPushCommReportRsp";
    }
    ...
    public boolean equals(Object obj) {
        ...
        return JceUtil.equals(this.padding, ((TpnsPushCommReportRsp) obj).padding);
    }
