...
class AppCompatDelegateImpl extends AppCompatDelegate implements Factory2, Callback {
    ...
    /* renamed from: androidx.appcompat.app.AppCompatDelegateImpl$ActionBarDrawableToggleImpl */
    ...
    /* renamed from: androidx.appcompat.app.AppCompatDelegateImpl$ActionMenuPresenterCallback */
    ...
    /* renamed from: androidx.appcompat.app.AppCompatDelegateImpl$ActionModeCallbackWrapperV9 */
    ...
    /* renamed from: androidx.appcompat.app.AppCompatDelegateImpl$AppCompatWindowCallback */
    ...
    /* renamed from: androidx.appcompat.app.AppCompatDelegateImpl$AutoBatteryNightModeManager */
    ...
    /* renamed from: androidx.appcompat.app.AppCompatDelegateImpl$AutoNightModeManager */
    ...
    /* renamed from: androidx.appcompat.app.AppCompatDelegateImpl$AutoTimeNightModeManager */
    ...
    /* renamed from: androidx.appcompat.app.AppCompatDelegateImpl$ListMenuDecorView */
    ...
    /* renamed from: androidx.appcompat.app.AppCompatDelegateImpl$PanelFeatureState */
    protected static final class PanelFeatureState {
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0039R.C0043layout.abc_list_menu_item_layout);
    ...
    /* renamed from: androidx.appcompat.app.AppCompatDelegateImpl$PanelMenuPresenterCallback */
        ...
        if (obtainStyledAttributes.hasValue(C0039R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    viewGroup = (ViewGroup) from.inflate(C0039R.C0043layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    viewGroup = (ViewGroup) from.inflate(C0039R.C0043layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                ...
                viewGroup = (ViewGroup) from.inflate(C0039R.C0043layout.abc_dialog_title_material, null);
                ...
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0039R.C0043layout.abc_screen_toolbar, null);
