...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new Comparator<Snake>() {
        public int compare(Snake snake, Snake snake2) {
            int i = snake.f33x - snake2.f33x;
            return i == 0 ? snake.f34y - snake2.f34y : i;
        }
    };

    /* renamed from: androidx.recyclerview.widget.DiffUtil$Callback */
    ...
    /* renamed from: androidx.recyclerview.widget.DiffUtil$DiffResult */
    public static class DiffResult {
        ...
        private void addRootSnake() {
            ...
            if (snake == null || snake.f33x != 0 || snake.f34y != 0) {
        ...
        private void findMatchingItems() {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                int i3 = snake.f33x + snake.size;
                int i4 = snake.f34y + snake.size;
                ...
                for (int i5 = 0; i5 < snake.size; i5++) {
                    int i6 = snake.f33x + i5;
                    int i7 = snake.f34y + i5;
        ...
        private boolean findMatchingItem(int i, int i2, int i3, boolean z) {
            ...
            while (i3 >= 0) {
                ...
                int i6 = snake.f33x + snake.size;
                int i7 = snake.f34y + snake.size;
                int i8 = 8;
                if (z) {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                Snake snake = (Snake) this.mSnakes.get(size);
                int i3 = snake.size;
                int i4 = snake.f33x + i3;
                int i5 = snake.f34y + i3;
                if (i4 < i) {
                ...
                for (int i6 = i3 - 1; i6 >= 0; i6--) {
                    if ((this.mOldItemStatuses[snake.f33x + i6] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(snake.f33x + i6, 1, this.mCallback.getChangePayload(snake.f33x + i6, snake.f34y + i6));
                    }
                }
                i = snake.f33x;
                i2 = snake.f34y;
    ...
    /* renamed from: androidx.recyclerview.widget.DiffUtil$ItemCallback */
    ...
    /* renamed from: androidx.recyclerview.widget.DiffUtil$PostponedUpdate */
    ...
    /* renamed from: androidx.recyclerview.widget.DiffUtil$Range */
    static class Range {
        int newListEnd;
        int newListStart;
        int oldListEnd;
    ...
    /* renamed from: androidx.recyclerview.widget.DiffUtil$Snake */
    static class Snake {
        boolean removal;
        boolean reverse;
        int size;
    ...
    public static DiffResult calculateDiff(Callback callback, boolean z) {
        ...
        while (!arrayList2.isEmpty()) {
            ...
            if (diffPartial != null) {
                ...
                diffPartial.f33x += range.oldListStart;
                diffPartial.f34y += range.newListStart;
                Range range2 = arrayList3.isEmpty() ? new Range() : (Range) arrayList3.remove(arrayList3.size() - 1);
                range2.oldListStart = range.oldListStart;
                range2.newListStart = range.newListStart;
                if (diffPartial.reverse) {
                    range2.oldListEnd = diffPartial.f33x;
                    range2.newListEnd = diffPartial.f34y;
                } else if (diffPartial.removal) {
                    range2.oldListEnd = diffPartial.f33x - 1;
                    range2.newListEnd = diffPartial.f34y;
                } else {
                    range2.oldListEnd = diffPartial.f33x;
                    range2.newListEnd = diffPartial.f34y - 1;
                }
                arrayList2.add(range2);
                if (!diffPartial.reverse) {
                    range.oldListStart = diffPartial.f33x + diffPartial.size;
                    range.newListStart = diffPartial.f34y + diffPartial.size;
                } else if (diffPartial.removal) {
                    range.oldListStart = diffPartial.f33x + diffPartial.size + 1;
                    range.newListStart = diffPartial.f34y + diffPartial.size;
                } else {
                    range.oldListStart = diffPartial.f33x + diffPartial.size;
                    range.newListStart = diffPartial.f34y + diffPartial.size + 1;
                }
