...
public interface IRemoteServiceCallback extends IInterface {
    ...
    /* renamed from: com.alipay.android.app.IRemoteServiceCallback$Stub */
    public static abstract class Stub extends Binder implements IRemoteServiceCallback {
        ...
        private static class C1396a implements IRemoteServiceCallback {
            /* renamed from: a */
            private IBinder f3597a;

            C1396a(IBinder iBinder) {
                this.f3597a = iBinder;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                ...
                parcel2.writeNoException();
                parcel2.writeInt(isHideLoadingScreen);
                return true;
