...
public class C2240g {
    /* renamed from: a */
    public static String m9576a(int i) {
        if (i == 201) {
        ...
        switch (i) {
            case ESharkCode.ERR_NORMAL_SYSTEM_UNSUPPRORTED /*-13*/:
                return "广告请求使用了错误代码位";
            case ESharkCode.ERR_NORMAL_LOGIC /*-12*/:
                return "缓存中没有开屏广告";
            case ESharkCode.ERR_NORMAL_CANCEL /*-11*/:
                return "缓存过期";
            case ESharkCode.ERR_NORMAL_ILLEGAL_ARGUMENT /*-10*/:
                return "缓存解析失败";
