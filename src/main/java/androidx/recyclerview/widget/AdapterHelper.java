...
class AdapterHelper implements Callback {
    ...
    /* renamed from: androidx.recyclerview.widget.AdapterHelper$Callback */
    interface Callback {
    ...
    /* renamed from: androidx.recyclerview.widget.AdapterHelper$UpdateOp */
    ...
    private void dispatchAndUpdateViewHolders(UpdateOp updateOp) {
        ...
        for (int i7 = 1; i7 < updateOp.itemCount; i7++) {
            ...
            int i8 = updateOp.cmd;
            boolean z = i8 == 2 ? updatePositionWithPostponed2 == i4 : i8 == 4 && updatePositionWithPostponed2 == i4 + 1;
            if (z) {
                i6++;
            } else {
