...
public class Chip extends AppCompatCheckBox implements Delegate {
    ...
    /* renamed from: com.google.android.material.chip.Chip$ChipTouchHelper */
        ...
        public void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (Chip.this.hasCloseIcon()) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i2 = C2622R.string.mtrl_chip_close_icon_content_description;
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2622R.attr.chipStyle);
    }
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        ChipDrawable createFromAttributes = ChipDrawable.createFromAttributes(context, attributeSet, i, C2622R.style.Widget_MaterialComponents_Chip_Action);
    ...
    public void drawableStateChanged() {
        ...
        ChipDrawable chipDrawable2 = this.chipDrawable;
        boolean closeIconState = (chipDrawable2 == null || !chipDrawable2.isCloseIconStateful()) ? false : this.chipDrawable.setCloseIconState(createCloseIconDrawableState());
        if (closeIconState) {
            invalidate();
        }
    }
