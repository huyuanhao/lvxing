...
public final class GeneralRoundFrameLayout extends FrameLayout {
    ...
    public GeneralRoundFrameLayout(Context context, AttributeSet attributeSet) {
        ...
        m13650a(this, context, attributeSet);
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        GeneralRoundViewImpl aVar = this.f11385a;
        if (aVar == null) {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        GeneralRoundViewImpl aVar2 = this.f11385a;
        if (aVar2 == null) {
            C8271i.m35387b(str);
        }
    ...
    /* renamed from: a */
    private final void m13650a(View view, Context context, AttributeSet attributeSet) {
        int[] iArr = R.styleable.GeneralRoundFrameLayout;
        C8271i.m35382a((Object) iArr, "R.styleable.GeneralRoundFrameLayout");
