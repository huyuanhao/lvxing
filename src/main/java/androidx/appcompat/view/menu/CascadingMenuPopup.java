...
final class CascadingMenuPopup extends MenuPopup implements OnKeyListener, OnDismissListener, MenuPresenter {
    ...
    private static final int ITEM_LAYOUT = C0039R.C0043layout.abc_cascading_menu_item_layout;
    ...
    /* renamed from: androidx.appcompat.view.menu.CascadingMenuPopup$CascadingMenuInfo */
    ...
    /* renamed from: androidx.appcompat.view.menu.CascadingMenuPopup$HorizPosition */
    ...
    private void showMenu(MenuBuilder menuBuilder) {
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) from.inflate(C0039R.C0043layout.abc_popup_menu_header_item_layout, listView, false);
