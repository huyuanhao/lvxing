...
public class SimpleCursorAdapter extends ResourceCursorAdapter {
    ...
    /* renamed from: androidx.cursoradapter.widget.SimpleCursorAdapter$CursorToStringConverter */
    public interface CursorToStringConverter {
        CharSequence convertToString(Cursor cursor);
    }

    /* renamed from: androidx.cursoradapter.widget.SimpleCursorAdapter$ViewBinder */
