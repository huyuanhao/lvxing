...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mCloseItemLayout = obtainStyledAttributes.getResourceId(C0039R.styleable.ActionMode_closeItemLayout, C0039R.C0043layout.abc_action_mode_close_item_material);
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0039R.C0043layout.abc_action_bar_title_item, this);
