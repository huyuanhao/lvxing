...
/* renamed from: com.tencent.mta.track.util.f */
public class C7467f {
    /* renamed from: a */
    static final byte[] f25027a = "03a976511e2cbe3a7f26808fb7af3c05".getBytes();

    /* renamed from: a */
    public static byte[] m32335a(byte[] bArr) {
        return m32336a(bArr, f25027a);
    }

    /* renamed from: b */
    public static byte[] m32337b(byte[] bArr) {
        return m32338b(bArr, f25027a);
    }
    ...
    /* renamed from: a */
    static byte[] m32336a(byte[] r8, ? r9) {
        /*
    ...
    L_0x0064:
        return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mta.track.util.C7467f.m32336a(byte[], byte[]):byte[]");
    }

    /* renamed from: b */
    static byte[] m32338b(byte[] bArr, byte[] bArr2) {
        return m32336a(bArr, bArr2);
    }
}
