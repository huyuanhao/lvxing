...
public abstract class BaseContinuationImpl implements Serializable, Continuation<Object>, CoroutineStackFrame {
    ...
    public BaseContinuationImpl(Continuation<Object> aVar) {
    ...
    public final void resumeWith(Object obj) {
        ...
        while (true) {
            ...
            DebugProbes.m35314a(baseContinuationImpl);
            Continuation aVar2 = baseContinuationImpl.completion;
            if (aVar2 == null) {
                C8271i.m35380a();
            }
            try {
                Object invokeSuspend = baseContinuationImpl.invokeSuspend(obj);
                if (invokeSuspend != C8216a.m35301a()) {
                    C8178a aVar3 = Result.Companion;
                    obj = Result.m35237constructorimpl(invokeSuspend);
                ...
                C8178a aVar4 = Result.Companion;
                obj = Result.m35237constructorimpl(C8242f.m35357a(th));
            }
        }
    }
    ...
    public CoroutineStackFrame getCallerFrame() {
        ...
        if (!(aVar instanceof CoroutineStackFrame)) {
            aVar = null;
        }
        return (CoroutineStackFrame) aVar;
    }

    public StackTraceElement getStackTraceElement() {
        return C8220c.m35310a(this);
    }
}
