...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f9505FS = '\u001c';
    /* renamed from: GS */
    private static final char f9506GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';
    /* renamed from: NS */
    private static final char f9507NS = '￻';
    private static final char PAD = '￼';
    /* renamed from: RS */
    private static final char f9508RS = '\u001e';
    ...
    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, 25, 26, 27, 28, 29, 30, 19, 20, 21, 22, 23, 24, JceStruct.SIMPLE_LIST, 14, 15, 16, 17, 18, 7, 8, 9, 10, JceStruct.STRUCT_END, JceStruct.ZERO_TAG, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, 31, 32})), SETS[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, 25, 26})), SETS[0].charAt(getInt(bArr, new byte[]{27, 28, 29, 30, 19, 20})), SETS[0].charAt(getInt(bArr, new byte[]{21, 22, 23, 24, JceStruct.SIMPLE_LIST, 14})), SETS[0].charAt(getInt(bArr, new byte[]{15, 16, 17, 18, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, JceStruct.STRUCT_END, JceStruct.ZERO_TAG, 1, 2}))});
    }
