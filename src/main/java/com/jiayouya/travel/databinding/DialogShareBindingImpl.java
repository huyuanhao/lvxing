...
public class DialogShareBindingImpl extends DialogShareBinding {
    /* renamed from: e */
    private static final IncludedLayouts f10620e = null;
    /* renamed from: f */
    private static final SparseIntArray f10621f = new SparseIntArray();
    /* renamed from: g */
    private final LinearLayout f10622g;
    /* renamed from: h */
    private final FrameLayout f10623h;
    /* renamed from: i */
    ...
    static {
        f10621f.put(R.id.list, 2);
        f10621f.put(R.id.iv_wx, 3);
        f10621f.put(R.id.iv_wx_circle, 4);
        f10621f.put(R.id.iv_close, 5);
    }

    public DialogShareBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 6, f10620e, f10621f));
    }

    private DialogShareBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[5], (TextView) objArr[3], (TextView) objArr[4], (RecyclerView) objArr[2]);
        this.f10624i = -1;
        this.f10622g = objArr[0];
        this.f10622g.setTag(null);
        this.f10623h = objArr[1];
        this.f10623h.setTag(null);
        setRootTag(view);
        invalidateAll();
    }
    ...
    public void executeBindings() {
        ...
        if ((j & 1) != 0) {
            FrameLayout frameLayout = this.f10623h;
            Integer num = null;
            Integer num2 = num;
            Integer num3 = num;
            Integer num4 = num;
