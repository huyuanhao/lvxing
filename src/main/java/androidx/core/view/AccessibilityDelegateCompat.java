...
public class AccessibilityDelegateCompat {
    ...
    /* renamed from: androidx.core.view.AccessibilityDelegateCompat$AccessibilityDelegateAdapter */
    ...
    public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
        ...
        return (z || i != C0161R.C0163id.accessibility_action_clickable_span) ? z : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }

    private boolean performClickableSpanAction(int i, View view) {
        SparseArray sparseArray = (SparseArray) view.getTag(C0161R.C0163id.tag_accessibility_clickable_spans);
        if (sparseArray != null) {
    ...
    static List<AccessibilityActionCompat> getActionList(View view) {
        List<AccessibilityActionCompat> list = (List) view.getTag(C0161R.C0163id.tag_accessibility_actions);
