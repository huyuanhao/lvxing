...
public class AnimatorInflaterCompat {
    ...
    /* renamed from: androidx.vectordrawable.graphics.drawable.AnimatorInflaterCompat$PathDataEvaluator */
    ...
    private static int inferValueTypeOfKeyframe(Resources resources, Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        ...
        int i = 0;
        TypedValue peekNamedValue = TypedArrayUtils.peekNamedValue(obtainAttributes, xmlPullParser, ArgKey.KEY_VALUE, 0);
