...
public class ChangeImageTransform extends Transition {
     ...
     */
        ...
        L_0x001f:
            return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.transition.ChangeImageTransform.C05043.m40232clinit():void");
        }
    }
    ...
    private static Matrix copyImageMatrix(ImageView imageView) {
        int i = C05043.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
        if (i == 1) {
