...
import androidx.gridlayout.C0315R;
...
public class GridLayout extends ViewGroup {
    private static final int ALIGNMENT_MODE = C0315R.styleable.GridLayout_alignmentMode;
    ...
    private static final int COLUMN_COUNT = C0315R.styleable.GridLayout_columnCount;
    private static final int COLUMN_ORDER_PRESERVED = C0315R.styleable.GridLayout_columnOrderPreserved;
    ...
    private static final int ORIENTATION = C0315R.styleable.GridLayout_orientation;
    public static final Alignment RIGHT = createSwitchingAlignment(END, START);
    private static final int ROW_COUNT = C0315R.styleable.GridLayout_rowCount;
    private static final int ROW_ORDER_PRESERVED = C0315R.styleable.GridLayout_rowOrderPreserved;
    ...
    private static final int USE_DEFAULT_MARGINS = C0315R.styleable.GridLayout_useDefaultMargins;
    ...
    /* renamed from: androidx.gridlayout.widget.GridLayout$Alignment */
    ...
    /* renamed from: androidx.gridlayout.widget.GridLayout$Arc */
    ...
    /* renamed from: androidx.gridlayout.widget.GridLayout$Assoc */
    static final class Assoc<K, V> extends ArrayList<Pair<K, V>> {
        ...
        /* renamed from: of */
        public static <K, V> Assoc<K, V> m13of(Class<K> cls, Class<V> cls2) {
    ...
    /* renamed from: androidx.gridlayout.widget.GridLayout$Axis */
    final class Axis {
        ...
        private MutableInt parentMax = new MutableInt(ESharkCode.ERR_NETWORK_PROTOCOLEXCEPTION);
        ...
        private PackedMap<Spec, Bounds> createGroupBounds() {
            Assoc of = Assoc.m13of(Spec.class, Bounds.class);
            int childCount = GridLayout.this.getChildCount();
        ...
        private PackedMap<Interval, MutableInt> createLinks(boolean z) {
            Assoc of = Assoc.m13of(Interval.class, MutableInt.class);
    ...
    /* renamed from: androidx.gridlayout.widget.GridLayout$Bounds */
    static class Bounds {
        public int after;
        public int before;
    ...
    /* renamed from: androidx.gridlayout.widget.GridLayout$Interval */
    ...
    public static class LayoutParams extends MarginLayoutParams {
        private static final int BOTTOM_MARGIN = C0315R.styleable.GridLayout_Layout_android_layout_marginBottom;
        private static final int COLUMN = C0315R.styleable.GridLayout_Layout_layout_column;
        private static final int COLUMN_SPAN = C0315R.styleable.GridLayout_Layout_layout_columnSpan;
        private static final int COLUMN_WEIGHT = C0315R.styleable.GridLayout_Layout_layout_columnWeight;
        ...
        private static final int GRAVITY = C0315R.styleable.GridLayout_Layout_layout_gravity;
        private static final int LEFT_MARGIN = C0315R.styleable.GridLayout_Layout_android_layout_marginLeft;
        private static final int MARGIN = C0315R.styleable.GridLayout_Layout_android_layout_margin;
        private static final int RIGHT_MARGIN = C0315R.styleable.GridLayout_Layout_android_layout_marginRight;
        private static final int ROW = C0315R.styleable.GridLayout_Layout_layout_row;
        private static final int ROW_SPAN = C0315R.styleable.GridLayout_Layout_layout_rowSpan;
        private static final int ROW_WEIGHT = C0315R.styleable.GridLayout_Layout_layout_rowWeight;
        private static final int TOP_MARGIN = C0315R.styleable.GridLayout_Layout_android_layout_marginTop;
        ...
        private void reInitSuper(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0315R.styleable.GridLayout_Layout);
            try {
    ...
    /* renamed from: androidx.gridlayout.widget.GridLayout$MutableInt */
    ...
    /* renamed from: androidx.gridlayout.widget.GridLayout$PackedMap */
    ...
    /* renamed from: androidx.gridlayout.widget.GridLayout$Spec */
    ...
    public GridLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mDefaultGap = context.getResources().getDimensionPixelOffset(C0315R.dimen.default_gap);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0315R.styleable.GridLayout);
        try {
