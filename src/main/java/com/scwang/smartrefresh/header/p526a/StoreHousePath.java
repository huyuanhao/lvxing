...
/* renamed from: com.scwang.smartrefresh.header.a.b */
public class StoreHousePath {
    /* renamed from: a */
    private static final SparseArray<float[]> f20554a = new SparseArray<>();
    ...
    static {
        ...
        for (int i = 0; i < fArr.length; i++) {
            f20554a.append(i + 65, fArr[i]);
        }
        for (int i2 = 0; i2 < fArr.length; i2++) {
            f20554a.append(i2 + 65 + 32, fArr[i2]);
        }
        for (int i3 = 0; i3 < fArr2.length; i3++) {
            f20554a.append(i3 + 48, fArr2[i3]);
        }
        f20554a.append(32, new float[0]);
        f20554a.append(45, new float[]{0.0f, 36.0f, 47.0f, 36.0f});
        f20554a.append(46, new float[]{24.0f, 60.0f, 24.0f, 72.0f});
    }

    /* renamed from: a */
    public static List<float[]> m25374a(String str, float f, int i) {
        ArrayList arrayList = new ArrayList();
        float f2 = 0.0f;
        for (int i2 = 0; i2 < str.length(); i2++) {
            char charAt = str.charAt(i2);
            if (f20554a.indexOfKey(charAt) != -1) {
                float[] fArr = (float[]) f20554a.get(charAt);
