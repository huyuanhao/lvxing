...
public class ViewPager extends ViewGroup {
    ...
    /* renamed from: androidx.viewpager.widget.ViewPager$DecorView */
    ...
    /* renamed from: androidx.viewpager.widget.ViewPager$MyAccessibilityDelegate */
    ...
    /* renamed from: androidx.viewpager.widget.ViewPager$OnAdapterChangeListener */
    ...
    /* renamed from: androidx.viewpager.widget.ViewPager$PageTransformer */
    public interface PageTransformer {
        void transformPage(View view, float f);
    }

    /* renamed from: androidx.viewpager.widget.ViewPager$PagerObserver */
    ...
    /* renamed from: androidx.viewpager.widget.ViewPager$SimpleOnPageChangeListener */
    ...
    /* renamed from: androidx.viewpager.widget.ViewPager$ViewPositionComparator */
    ...
    public boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        for (i3 = 
/*
Method generation error in method: androidx.viewpager.widget.ViewPager.onRequestFocusInDescendants(int, android.graphics.Rect):boolean, dex: classes.dex
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r0v1 'i3' int) = (r0v4 'i3' int), (r0v5 'i3' int) binds: {(r0v4 'i3' int)=B:3:0x000f, (r0v5 'i3' int)=B:2:0x000b} in method: androidx.viewpager.widget.ViewPager.onRequestFocusInDescendants(int, android.graphics.Rect):boolean, dex: classes.dex
