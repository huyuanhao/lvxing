...
public class ChangeTransform extends Transition {
    ...
    /* renamed from: androidx.transition.ChangeTransform$GhostListener */
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            this.mView.setTag(C0516R.C0518id.transition_transform, null);
            this.mView.setTag(C0516R.C0518id.parent_matrix, null);
        }
    ...
    /* renamed from: androidx.transition.ChangeTransform$PathAnimatorMatrix */
    ...
    /* renamed from: androidx.transition.ChangeTransform$Transforms */
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (view.getVisibility() != 8) {
            ...
            if (this.mReparent) {
                ...
                transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0516R.C0518id.transition_transform));
                transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0516R.C0518id.parent_matrix));
            }
        }
    }
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, boolean z) {
        ...
        final boolean z2 = z;
        C05073 r1 = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                if (!this.mIsCanceled) {
                    if (!z2 || !ChangeTransform.this.mUseOverlay) {
                        view.setTag(C0516R.C0518id.transition_transform, null);
                        view.setTag(C0516R.C0518id.parent_matrix, null);
                    } else {
            ...
            private void setCurrentMatrix(Matrix matrix) {
                ...
                view.setTag(C0516R.C0518id.transition_transform, this.mTempMatrix);
                transforms.restore(view);
            }
        };
    ...
    private void setMatricesForParent(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        Matrix matrix = (Matrix) map.get(str);
        transitionValues2.view.setTag(C0516R.C0518id.parent_matrix, matrix);
