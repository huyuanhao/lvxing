...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    private final Callback dragCallback = new Callback() {
        ...
        L_0x00f8:
            return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.bottomsheet.BottomSheetBehavior.C26472.onViewReleased(android.view.View, float, float):void");
        }
    ...
    /* renamed from: com.google.android.material.bottomsheet.BottomSheetBehavior$BottomSheetCallback */
    ...
    /* renamed from: com.google.android.material.bottomsheet.BottomSheetBehavior$SettleRunnable */
    ...
    /* renamed from: com.google.android.material.bottomsheet.BottomSheetBehavior$State */
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2622R.styleable.BottomSheetBehavior_Layout);
        TypedValue peekValue = obtainStyledAttributes.peekValue(C2622R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight);
        if (peekValue == null || peekValue.data != -1) {
            setPeekHeight(obtainStyledAttributes.getDimensionPixelSize(C2622R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1));
        } else {
            setPeekHeight(peekValue.data);
        }
        setHideable(obtainStyledAttributes.getBoolean(C2622R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setFitToContents(obtainStyledAttributes.getBoolean(C2622R.styleable.BottomSheetBehavior_Layout_behavior_fitToContents, true));
        setSkipCollapsed(obtainStyledAttributes.getBoolean(C2622R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v, int i) {
        ...
        if (this.peekHeightAuto) {
            if (this.peekHeightMin == 0) {
                this.peekHeightMin = coordinatorLayout.getResources().getDimensionPixelSize(C2622R.dimen.design_bottom_sheet_peek_height_min);
            }
    ...
    public void setFitToContents(boolean z) {
        if (this.fitToContents != z) {
            ...
            int i = (!this.fitToContents || this.state != 6) ? this.state : 3;
            setStateInternal(i);
        }
    }
