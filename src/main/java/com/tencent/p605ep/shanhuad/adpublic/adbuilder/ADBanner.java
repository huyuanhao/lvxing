...
/* renamed from: com.tencent.ep.shanhuad.adpublic.adbuilder.ADBanner */
public class ADBanner extends ADSplashImage {
    public void load(AdInfoListener adInfoListener, List<AdID> list) {
        this.f24760gk = adInfoListener;
        super.mo41444a(C8680f.m37693b(list, 6, 1), new AdListenerImpl());
    }
}
