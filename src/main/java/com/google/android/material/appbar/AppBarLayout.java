...
public class AppBarLayout extends LinearLayout {
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        /* renamed from: com.google.android.material.appbar.AppBarLayout$BaseBehavior$BaseDragCallback */
    ...
    /* renamed from: com.google.android.material.appbar.AppBarLayout$BaseOnOffsetChangedListener */
    ...
    public static class Behavior extends BaseBehavior<AppBarLayout> {
        ...
        /* renamed from: com.google.android.material.appbar.AppBarLayout$Behavior$DragCallback */
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        /* renamed from: com.google.android.material.appbar.AppBarLayout$LayoutParams$ScrollFlags */
        public @interface ScrollFlags {
        }

        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2622R.styleable.AppBarLayout_Layout);
            this.scrollFlags = obtainStyledAttributes.getInt(C2622R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (obtainStyledAttributes.hasValue(C2622R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = android.view.animation.AnimationUtils.loadInterpolator(context, obtainStyledAttributes.getResourceId(C2622R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
    ...
    /* renamed from: com.google.android.material.appbar.AppBarLayout$OnOffsetChangedListener */
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2622R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(obtainStyledAttributes.getDimensionPixelSize(C2622R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            obtainStyledAttributes.recycle();
        }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attributeSet, 0, C2622R.style.Widget_Design_AppBarLayout);
        }
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2622R.styleable.AppBarLayout, 0, C2622R.style.Widget_Design_AppBarLayout, new int[0]);
        ViewCompat.setBackground(this, obtainStyledAttributes.getDrawable(C2622R.styleable.AppBarLayout_android_background));
        if (obtainStyledAttributes.hasValue(C2622R.styleable.AppBarLayout_expanded)) {
            setExpanded(obtainStyledAttributes.getBoolean(C2622R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (VERSION.SDK_INT >= 21 && obtainStyledAttributes.hasValue(C2622R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, (float) obtainStyledAttributes.getDimensionPixelSize(C2622R.styleable.AppBarLayout_elevation, 0));
        }
        if (VERSION.SDK_INT >= 26) {
            if (obtainStyledAttributes.hasValue(C2622R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(obtainStyledAttributes.getBoolean(C2622R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (obtainStyledAttributes.hasValue(C2622R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(obtainStyledAttributes.getBoolean(C2622R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        this.liftOnScroll = obtainStyledAttributes.getBoolean(C2622R.styleable.AppBarLayout_liftOnScroll, false);
        obtainStyledAttributes.recycle();
    ...
    public int[] onCreateDrawableState(int i) {
        ...
        iArr[0] = this.liftable ? C2622R.attr.state_liftable : -C2622R.attr.state_liftable;
        int i2 = (!this.liftable || !this.lifted) ? -C2622R.attr.state_lifted : C2622R.attr.state_lifted;
        iArr[1] = i2;
        iArr[2] = this.liftable ? C2622R.attr.state_collapsible : -C2622R.attr.state_collapsible;
        int i3 = (!this.liftable || !this.lifted) ? -C2622R.attr.state_collapsed : C2622R.attr.state_collapsed;
        iArr[3] = i3;
