...
public class BasicClassTypeUtil {
    ...
    L_0x007f:
        return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p522qq.jce.wup.BasicClassTypeUtil.createClassByUni(java.lang.String):java.lang.Object");
    }

    public static String getClassTransName(String str) {
        return str.equals("int") ? "Integer" : str.equals(SettingsContentProvider.BOOLEAN_TYPE) ? "Boolean" : str.equals("byte") ? "Byte" : str.equals("double") ? "Double" : str.equals(SettingsContentProvider.FLOAT_TYPE) ? "Float" : str.equals(SettingsContentProvider.LONG_TYPE) ? "Long" : str.equals("short") ? "Short" : str.equals("char") ? "Character" : str;
    }
    ...
    public static ArrayList<String> getTypeList(String str) {
        ...
        int i = 0;
        while (i < indexOf) {
            addType(arrayList, str.substring(i, indexOf));
            i = indexOf + 1;
    ...
    public static String getVariableInit(String str, String str2) {
        ...
        if (str2.equals("int")) {
            ...
            if (str2.equals(SettingsContentProvider.BOOLEAN_TYPE)) {
                ...
                if (str2.equals("byte")) {
                    ...
                    sb3 = new StringBuilder();
                } else if (str2.equals(SettingsContentProvider.FLOAT_TYPE)) {
                    sb3 = new StringBuilder();
                } else if (str2.equals(SettingsContentProvider.LONG_TYPE)) {
                    sb3 = new StringBuilder();
    ...
    public static boolean isBasicType(String str) {
        return str.equals("int") || str.equals(SettingsContentProvider.BOOLEAN_TYPE) || str.equals("byte") || str.equals("double") || str.equals(SettingsContentProvider.FLOAT_TYPE) || str.equals(SettingsContentProvider.LONG_TYPE) || str.equals("short") || str.equals("char") || str.equals("Integer") || str.equals("Boolean") || str.equals("Byte") || str.equals("Double") || str.equals("Float") || str.equals("Long") || str.equals("Short") || str.equals("Char");
    }
    ...
    public static void main(String[] strArr) {
        ...
        while (it.hasNext()) {
            ArrayList typeList = getTypeList((String) it.next());
            ...
            sb.append("-------------finished ");
            sb.append(transTypeList(typeList));
