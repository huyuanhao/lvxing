            ...
            for (int i = 0; i < length; i++) {
                ...
                if (i2 >= 0) {
                    ...
                    for (int i3 = 0; i3 < length2; i3++) {
                        int i4 = iArr[i3];
                        if (i4 >= 0 && isEmpty(byteMatrix.get(i4, i2))) {
                            embedPositionAdjustmentPattern(i4 - 2, i2 - 2, byteMatrix);
                        }
                    }
                }
            }
