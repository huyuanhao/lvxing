...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                C0301Op op = (C0301Op) this.mOps.get(i);
                switch (op.mCmd) {
                    case 0:
                        str2 = "NULL";
                        break;
    ...
    public void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                C0301Op op = (C0301Op) this.mOps.get(i2);
    ...
    public boolean interactsWith(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            C0301Op op = (C0301Op) this.mOps.get(i4);
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        C0301Op op2 = (C0301Op) backStackRecord.mOps.get(i7);
    ...
    public void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            C0301Op op = (C0301Op) this.mOps.get(size);
            Fragment fragment = op.mFragment;
            if (fragment != null) {
            ...
            if (i3 != 1) {
                if (i3 == 2) {
                        ...
                        if (fragment5.mContainerId == i4) {
                            if (fragment5 == fragment3) {
                                ...
                                if (fragment5 == fragment4) {
                                    this.mOps.add(i5, new C0301Op(9, fragment5));
                                    i5++;
                                    fragment4 = null;
                                }
                                C0301Op op2 = new C0301Op(3, fragment5);
                    ...
                    if (op.mFragment == fragment2) {
                        this.mOps.add(i2, new C0301Op(9, op.mFragment));
                        i2++;
                        fragment2 = null;
                    }
                } else if (i3 != 7) {
                    if (i3 == 8) {
                        this.mOps.add(i2, new C0301Op(9, fragment2));
                        i2++;
    ...
    public boolean isPostponed() {
        for (int i = 0; i < this.mOps.size(); i++) {
            if (isFragmentPostponed((C0301Op) this.mOps.get(i))) {
                return true;
            }
        }
        return false;
    ...
    private static boolean isFragmentPostponed(C0301Op op) {
        Fragment fragment = op.mFragment;
