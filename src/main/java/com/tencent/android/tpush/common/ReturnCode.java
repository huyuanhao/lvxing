...
public enum ReturnCode {
    ...
    CODE_SUCCESS(0, "成功"),
    ERRORCODE_UNKNOWN(C7516p.f25219Cf, "起始错误"),
    CODE_LOGIC_ILLEGAL_ARGUMENT(ProfileID.PID_KVProfile_ACCOUNT, "操作类型错误码，例如参数错误时将会发生该错误"),
    ...
    CODE_ACCESSKET_OR_ACCESSID_ERROR(10006, r9),
    CODE_SERVICE_DISABLED(10007, "初始化信鸽Service错误"),
    CODE_PROVIDER_ERROR(10008, r9),
    ...
    public static String errCodeToMsg(int i) {
        ...
        switch (i) {
            case ProfileID.PID_KVProfile_ACCOUNT /*10001*/:
