...
public class LifecycleRegistry extends Lifecycle {
     ...
     */
        ...
        L_0x0091:
            return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.LifecycleRegistry.C03521.m39690clinit():void");
        }
    }

    /* renamed from: androidx.lifecycle.LifecycleRegistry$ObserverWithState */
    ...
    private static Event downEvent(State state) {
        int i = C03521.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
        if (i == 1) {
