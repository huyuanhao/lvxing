...
public final class TypedArrayKt {
    ...
    public static final int getDimensionPixelSizeOrThrow(TypedArray typedArray, int i) {
        C8271i.m35386b(typedArray, "$this$getDimensionPixelSizeOrThrow");
        checkAttribute(typedArray, i);
        return typedArray.getDimensionPixelSize(i, 0);
    }

    public static final Drawable getDrawableOrThrow(TypedArray typedArray, int i) {
        C8271i.m35386b(typedArray, "$this$getDrawableOrThrow");
        checkAttribute(typedArray, i);
    ...
    public static final float getFloatOrThrow(TypedArray typedArray, int i) {
        C8271i.m35386b(typedArray, "$this$getFloatOrThrow");
        checkAttribute(typedArray, i);
        return typedArray.getFloat(i, 0.0f);
    }

    public static final Typeface getFontOrThrow(TypedArray typedArray, int i) {
        C8271i.m35386b(typedArray, "$this$getFontOrThrow");
        checkAttribute(typedArray, i);
    ...
    public static final CharSequence getTextOrThrow(TypedArray typedArray, int i) {
        C8271i.m35386b(typedArray, "$this$getTextOrThrow");
        checkAttribute(typedArray, i);
    ...
    public static final CharSequence[] getTextArrayOrThrow(TypedArray typedArray, int i) {
        C8271i.m35386b(typedArray, "$this$getTextArrayOrThrow");
        checkAttribute(typedArray, i);
        CharSequence[] textArray = typedArray.getTextArray(i);
        C8271i.m35382a((Object) textArray, "getTextArray(index)");
        return textArray;
    }

    public static final <R> R use(TypedArray typedArray, C8247b<? super TypedArray, ? extends R> bVar) {
        C8271i.m35386b(typedArray, "$this$use");
