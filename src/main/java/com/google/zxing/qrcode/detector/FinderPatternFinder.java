...
public class FinderPatternFinder {
    ...
    /* renamed from: com.google.zxing.qrcode.detector.FinderPatternFinder$CenterComparator */
    ...
    /* renamed from: com.google.zxing.qrcode.detector.FinderPatternFinder$FurthestFromAverageComparator */
    ...
    public final FinderPatternInfo find(Map<DecodeHintType, ?> map) throws NotFoundException {
        ...
        while (i < height && !z2) {
            ...
            while (i2 < width) {
                if (this.image.get(i2, i)) {
                    ...
                    if (!foundPatternCross(iArr)) {
                        shiftCounts2(iArr);
                    } else if (handlePossibleCenter(iArr, i, i2)) {
                        if (this.hasSkipped) {
                            z3 = haveMultiplyConfirmedCenters();
                        } else {
                            int findRowSkip = findRowSkip();
                            if (findRowSkip > iArr[2]) {
                                i += (findRowSkip - iArr[2]) - 2;
                                i2 = width - 1;
                            }
                        }
                        clearCounts(iArr);
            ...
            if (!foundPatternCross(iArr) || !handlePossibleCenter(iArr, i, width)) {
                i5 = i6;
            } else {
                int i9 = iArr[0];
                if (this.hasSkipped) {
